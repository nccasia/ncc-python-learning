...
job_more_info=['id','title','skills','address','salary','type work','date post','company name','company text','type company','member company','day work','country company','OT','reason choice','job description','skills and experience','detail benefit']
def crawl_itviec():
    with sync_playwright() as p:
        ...
        while active<end:
            ...
            for job in jobs:
                ...
                jid= str(job.get_attribute('data-search--job-selection-job-slug-value')).split('-')[-1]
